...
export function ReceiptTemplate({
  ...
  if (layout === 'thermal') {
    ...
    return <div className="receipt-paper receipt-thermal receipt-java-style mx-auto w-full max-w-full bg-white px-[3mm] py-[4mm] font-['Courier_New',Courier,monospace] text-[11px] leading-[1.38] text-black print:w-full print:max-w-none print:px-[2mm] print:py-[3mm]">
      ...
      {sale.feedbackUrl && <div className="mt-4 border-y border-dotted border-zinc-700 py-3 text-center"><p className="font-bold">HOW DID WE DO?</p><div className="mt-2 flex justify-center"><ReceiptQrCode saleId={sale.id} receiptNo={sale.receiptNo} total="" paymentMethod="" createdAt={sale.createdAt} value={sale.feedbackUrl} label="Scan to rate your experience" /></div><p className="mt-1 text-[9px]">Scan to rate your experience</p></div>}
