          ...
          <div className="mt-7 h-[220px] sm:h-[252px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={sales} margin={{ left: -14, right: 5, top: 8 }}>
                ...
                <Line type="monotone" dataKey="expenses" name="Expenses" stroke="rgba(255,255,255,.48)" strokeWidth={2} dot={false} isAnimationActive={false} />
                <Line type="monotone" dataKey="revenue" name="Sales" stroke="#b9ef43" strokeWidth={3} dot={false} activeDot={{ r: 5, fill: '#b9ef43', stroke: '#1d1d2d', strokeWidth: 3 }} isAnimationActive={false} />
              </LineChart>
            </ResponsiveContainer>
          </div>
