...
const industries = [
  {
    ...
    stat: { number: '2,100+', label: 'retail stores using PESABY' },
  },
  {
    id: 'restaurant',
    ...
    <section id="industries" className="ind-section">
      <div className="ind-inner">
        ...
        <p className="ind-footer-note">
          ...
          <a href="mailto:hello@pesaby.co.ke" className="ind-footer-link">
            Talk to us — PESABY works for any product or service business.
          </a>
        </p>
