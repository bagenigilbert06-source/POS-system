...
export default async function PurchasesPage({ searchParams }: { searchParams: Promise<{ productId?: string }> }) {
  const authorization = await requireDashboardPermission(PermissionEnum.PURCHASE_VIEW)
