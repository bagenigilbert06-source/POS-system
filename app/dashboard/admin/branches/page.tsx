...
export default async function BranchesPage() {
  ...
  const rows = await db
    ...
    .from(branch)
    .leftJoin(branchMembership, eq(branchMembership.branchId, branch.id))
  ...
  return (
    <div className="space-y-5 pb-8">
      <AdminPageHeader
        ...
        description="Create locations, maintain branch details and protect locations that already contain operating records."
      />
      <BranchManagement
