  ...
  const groups: Record<BusinessTypeEnum, CategoryGroup> = {
    [BusinessTypeEnum.RETAIL]: {
      ...
      categories: [
        ...
        { id: BusinessCategoryEnum.PET_SHOP, name: 'Pet Shop' },
        { id: BusinessCategoryEnum.FURNITURE_STORE, name: 'Furniture Store' },
    ...
    [BusinessTypeEnum.PHARMACY]: {
      ...
      categories: [
        ...
        { id: BusinessCategoryEnum.WHOLESALE_PHARMACY, name: 'Wholesale Pharmacy' },
