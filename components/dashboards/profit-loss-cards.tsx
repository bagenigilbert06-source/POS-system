  ...
  const cards = [
    ...
    },
    {
      ...
      value:
        data.cogs == null
          ? 'Cost unavailable'
          : formatCurrency(data.cogs, currency),
      detail:
        data.cogs == null
          ? `Complete ${terminology.singularLower} costs`
          : `${terminology.singular} costs`,
      icon: DollarSign,
    ...
    },
    {
      ...
      value:
        data.operatingProfit == null
          ? 'Cost unavailable'
          : formatCurrency(data.operatingProfit, currency),
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      {cards.map((card) => {
        ...
        return (
          <div
            key={card.label}
            className="overflow-hidden rounded-xl border border-[#dfe3ea] bg-white shadow-[0_1px_2px_rgba(16,24,40,.03)]"
          >
            <div className="px-5 py-4 sm:px-6">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-3 text-[1.55rem] font-bold text-[#050a1f]">
                    {card.value}
                  </p>
