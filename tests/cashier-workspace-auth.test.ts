...
assert.match(cashierShiftStrip, /const submitModalOnEnter/);
assert.match(cashierShiftStrip, /data-drawer-submit/);
assert.match(cashierShiftStrip, /data-movement-submit/);
assert.match(cashierShiftStrip, /data-count-submit/);
