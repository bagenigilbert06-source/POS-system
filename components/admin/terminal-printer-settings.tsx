...
export function TerminalPrinterSettings({ terminal }: { terminal: Terminal }) {
  ...
  const testPrint = async () => {
    ...
    const html = `<div class="receipt-paper" style="font-family:Manrope,Inter,Arial,sans-serif;width:100%;box-sizing:border-box;padding:4mm 3mm;color:#000;background:#fff;font-size:10px;line-height:1.35"><style>.receipt-paper *{box-sizing:border-box}.receipt-head{text-align:center}.receipt-logo{display:block;width:18mm;height:14mm;object-fit:contain;margin:0 auto 2mm;filter:grayscale(1)}.receipt-head h1{font-size:16px;letter-spacing:.02em;margin:0;font-weight:800;text-transform:uppercase}.receipt-head p,.receipt-meta p{margin:1px 0}.receipt-rule{border:0;border-top:1px dashed #000;margin:8px 0}.receipt-columns,.receipt-item{display:grid;grid-template-columns:minmax(0,1fr) 24px 78px;gap:3px}.receipt-columns{font-size:8px;font-weight:800;text-transform:uppercase;border-bottom:1px solid #000;padding-bottom:3px}.receipt-item{padding:4px 0;border-bottom:1px dotted #777}.receipt-item small{display:block;font-size:7px}.receipt-amount{text-align:right;white-space:nowrap}.receipt-row{display:flex;justify-content:space-between;gap:8px}.receipt-row span:last-child{white-space:nowrap}.receipt-total{font-size:12px;font-weight:800;border-top:1px solid #000;margin-top:4px;padding-top:4px}.receipt-note{text-align:center;margin-top:9px}.receipt-footer{text-align:center;border-top:1px dashed #000;margin-top:9px;padding-top:7px;font-weight:800}</style><div class="receipt-head"><img class="receipt-logo" src="/pesaby-logo-v2.png" alt="" /><h1>${business}</h1>${branch ? `<p>${branch}</p>` : ''}<p>Tel: +254 746 741 719</p><p><b>SALES RECEIPT</b></p><div class="receipt-meta"><p>${esc(date)}</p><p>Receipt: RCP-TEST-0001</p><p>Cashier: James Miller</p><p>Customer: Walk-in customer</p></div></div><hr class="receipt-rule"><div class="receipt-columns"><span>Description</span><span style="text-align:center">Qty</span><span style="text-align:right">Amount</span></div><div class="receipt-item"><span>Jose Cuervo Especial Gold<small>SKU: DC250B50</small></span><span style="text-align:center">1</span><span class="receipt-amount">KSh 3,900.00</span></div><hr class="receipt-rule"><div class="receipt-row"><span>Total before VAT</span><span>KSh 3,362.07</span></div><div class="receipt-row"><span>VAT (16%) included</span><span>KSh 537.93</span></div><div class="receipt-row receipt-total"><span>TOTAL</span><span>KSh 3,900.00</span></div><div class="receipt-note"><b>1 ITEM SOLD</b><p>Paid by: Cash</p><p>Amount paid: KSh 3,900.00</p></div><div class="receipt-footer">Thank you for your business.<small style="display:block;font-size:7px;font-weight:400;margin-top:3px">Transaction: TEST0001</small></div></div>`;
    const thermalData = encodeThermalReceiptModel({ version: 1, businessName: terminal.businessName || 'LIQUOR STORE', logoUrl: '/pesaby-logo-v2.png', contactLines: [branch || 'Ruiru', 'Tel: +254746741719'], title: 'SALES RECEIPT', metadata: [date, 'Receipt: RCP-TEST-0001', 'Cashier: JAMES MILLER', 'Customer: Walk-in customer'], items: [{ description: 'Jose Cuervo Especial Gold', quantity: '1', unitPrice: 'KSh 3,900.00', amount: 'KSh 3,900.00', details: ['SKU: DC250B50'] }], totals: [{ label: 'Total before VAT', amount: 'KSh 3,362.07' }, { label: 'VAT (16%) included', amount: 'KSh 537.93' }], total: { label: 'TOTAL', amount: 'KSh 3,900.00' }, itemCountLabel: '1 ITEM SOLD', paymentLines: ['Paid by: Cash', 'Amount paid: KSh 3,900.00'], notices: [], footer: 'Thank you for your business.', transactionId: 'TEST0001' });
