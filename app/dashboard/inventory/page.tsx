...
export default async function InventoryPage() {
  const [{ organization }, products, control, authorization] = await Promise.all([
  ...
  return <div className="mx-auto w-full max-w-[1480px] space-y-5 pb-8">
    ...
    <InventoryManager products={activeProducts} movements={control.movements} adjustments={control.adjustments} adjustmentItems={control.adjustmentItems} currency={organization.currency} canAdjust={canAdjust} canPurchase={canPurchase} />
  </div>
}
