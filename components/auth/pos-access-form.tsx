...
export function PosAccessForm() {
  ...
  return <div>
    ...
    {method === 'pin' ? <PosPinLoginForm /> : <><p className="mb-3 text-center text-sm leading-6 text-zinc-600">Use your password for full dashboard access.</p><AuthForm mode="sign-in" compact /></>}
  </div>
}
