...
export default async function RootPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 font-sans text-slate-950">
      ...
      <main>
        {/* Modern Hero Section - Mizizzi Inspired */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen lg:min-h-[600px] py-16 sm:py-20 lg:py-24">
              ...
              <div>
                ...
                <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-amber-300 bg-white px-4 py-2 shadow-sm">
                  ...
                  <span className="text-sm font-semibold text-amber-900">Smart Retail Solutions</span>
                </div>

                {/* Headline - Split colors matching Mizizzi */}
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-10">
                  <Link href="/sign-up" className="inline-flex h-12 items-center justify-center rounded-lg bg-gradient-to-r from-amber-600 to-orange-600 text-white font-bold shadow-xl hover:from-amber-700 hover:to-orange-700 transition-all duration-300 px-8">
                    Activate free trial
                    <ArrowRight className="h-5 w-5 ml-2" aria-hidden="true" />
                  </Link>
                  <Link href="mailto:hello@pesaby.com" className="inline-flex h-12 items-center justify-center rounded-lg border-2 border-slate-900 bg-white text-slate-900 font-bold hover:bg-slate-50 transition-all duration-300 px-8">
                    Schedule Demo
                  </Link>
                </div>

                {/* Stats Row - 3 columns like Mizizzi */}
              ...
              <div className="relative h-96 sm:h-[500px] lg:h-[600px]">
                ...
                <div className="relative h-full w-full">
                  ...
                  {/* Floating card - Left */}
                  <div className="absolute -left-6 top-1/4 z-20 w-48 rounded-xl bg-white shadow-xl border border-amber-200 p-4">
                  ...
                  <div className="absolute -bottom-6 -right-6 z-20 w-40 rounded-xl bg-white shadow-xl border border-amber-200 p-4">
